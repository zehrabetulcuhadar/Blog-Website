<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="robotic.aspx.vb" Inherits="MyBlog.robotic" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <link href="css/roboticstyle.css" rel="stylesheet" />
    ...
    <form id="form1" runat="server">
        ...
        <div class="banner">
            <div class="image-container">
                <img src="images/roboticana.jpg" alt="Robotic" />
        ...
        <%-- İÇERİK --%>
        <div class="icerik">
        <h1 class="roboticbaslik">
            Robotik İle İlgili Blog Yazılarım
        </h1>
        <div class="post-container">
            <div class="post">
                <img src="images/roboticsq.jpg" alt="Alternate Text" class="post-img" />
                <div class="post-preview">
                    <h2><a href="roboticicerik.aspx" class="preview-title">Robotik Nedir ?</a></h2>
                    <p>
                        Robotik nedir ve gelecekte robotlar nasıl olacak ?
                    </p>
                    <a href="roboticicerik.aspx" class="readmore">read more</a>
                </div>
            </div>
            <div class="post">
                <img src="images/roboticsq.jpg" alt="Alternate Text" class="post-img" />
        ...
        <script>
            window.onload = function () {
                ...
                var heading = document.getElementsByClassName('roboticbaslik')[0];
